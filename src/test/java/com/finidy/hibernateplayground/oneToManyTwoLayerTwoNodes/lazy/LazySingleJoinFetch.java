...
public class LazySingleJoinFetch extends AbstractTest {
    @Autowired
    ...
    void loadSingleWithChildren(){
        long start = System.currentTimeMillis();
        Parent parent = parentRepository.findByIdWithChildren(1L).get();
    ...
    void loadSingleWithChildrenAndGrandChildren(){
        long start = System.currentTimeMillis();
        Parent parent = parentRepository.findByIdWithGrandChildren(1L).get();
