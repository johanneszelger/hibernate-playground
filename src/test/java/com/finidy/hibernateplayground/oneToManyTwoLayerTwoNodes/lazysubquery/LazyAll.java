...
public class LazyAll extends AbstractTest {
    ...
    void loadAllWithChildren() {
        ...
        System.out.println("Time taken: " + (System.currentTimeMillis() - start) + "ms");
        //this is kinda unexpected, but the subquery is executed for all parents at once
        assertSelectCount(3);
    ...
    void loadAllWithChildrenAndGrandChildren() {
        ...
        System.out.println("Time taken: " + (System.currentTimeMillis() - start) + "ms");
        //this is kinda unexpected, but the subquery is executed for all parents and children at once
